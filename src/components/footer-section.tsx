...
export function FooterSection() {
    return (
        <main id="contato" className="flex flex-col items-center justify-center w-full bg-slate-900 p-10">
            ...
            <div className="md:grid md:grid-cols-2 justify-center gap-24 p-24">
                <div className="rounded-full overflow-hidden md:p-10 p-2 max-lg:hidden">
                    <Image
                ...
                <div className="flex flex-col items-start justify-center space-y-10">
                    ...
                    <Link className="flex gap-3 items-center justify-center text-lime-300 hover:scale-105 duration-150 transition-all" href="https://www.facebook.com/lucas.aprigio.5?locale=pt_BR" target="blank">
                        <FaFacebook />
                        Facebook
                    </Link>
