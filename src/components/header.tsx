...
export function Header() {
    return (
        <main id="header" className="relative flex flex-col space-y-7 items-center justify-start h-screen md:p-20 bg-[url('/background.png')] bg-cover bg-no-repeat after:absolute after:left-0 after:top-0 after:w-full after:h-full after:bg-slate-900 after:opacity-90">
            <div className="z-50">
                <Image
                    src={logoSvg}
                    alt="Logo"
            ...
            <div className="flex flex-col items-center p-10 z-50">
